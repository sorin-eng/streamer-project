    ...
    <header className="border-b border-border bg-card">
      <div className="container mx-auto flex h-16 items-center gap-3 px-4">
        <Link to="/" className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-brand"><Zap className="h-4 w-4 text-primary-foreground" /></div>
          <span className="font-bold">BrokerHub</span>
        </Link>
      </div>
    </header>
...
export const TermsPage = () => (
  <LegalLayout title="Terms of Service">
    ...
    <p>BrokerHub is a B2B brokerage marketplace that connects licensed online casinos with gambling content creators (streamers/influencers). BrokerHub does NOT operate any gambling services, does NOT process gambling bets, and does NOT provide streaming services.</p>
    ...
    <p>BrokerHub charges a commission on successfully brokered deals. Fee schedules are disclosed during the deal finalization process.</p>
    <h2 className="text-lg font-semibold text-foreground mt-6">5. Disclaimer</h2>
    <p>BrokerHub is not responsible for the performance of deals between casinos and streamers. All agreements are between the respective parties.</p>
  </LegalLayout>
);
...
export const CompliancePage = () => (
  <LegalLayout title="Compliance Disclaimer">
    ...
    <div className="rounded-lg border border-warning/20 bg-warning/5 p-4 my-6">
      ...
      <p className="mt-2">BrokerHub is NOT a casino, NOT a gambling operator, and does NOT process any gambling transactions. This platform serves exclusively as a B2B brokerage connecting licensed casino operators with content creators.</p>
    </div>
